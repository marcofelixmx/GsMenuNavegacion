...
export class Convert {
    public static toUsuariosResponse(json: string): UsuariosResponse {
        return cast(JSON.parse(json), r("UsuariosResponse"));
    }

    public static usuariosResponseToJson(value: UsuariosResponse): string {
        return JSON.stringify(uncast(value, r("UsuariosResponse")), null, 2);
    }
}
